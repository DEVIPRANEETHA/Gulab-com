...
form.submit();
     ...
     <form:form action="DriverDetails" modelAttribute="user" method="post" style="border:5px solid grey;width:500px;padding:10px 10px 10px 30px;margin-top:50px;border-radius:15px;">
...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
	...
	<input type="reset" value="Reset" class="button"></td></tr></tbody></table></font>
      ...
      <img src="<c:url value="/resources/img/cars.jpg"/>" height="100%">
       </div>
       </div>
</body>
</html>